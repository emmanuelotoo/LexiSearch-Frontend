  ...
  return (
    <div className="min-h-screen bg-brand-dark flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-10 p-6 flex justify-between items-center">
        ...
        <Link to="/signup" className="text-sm font-mono text-stone-400 hover:text-brand-gold transition-colors">
          Create an account
        </Link>
      </header>
          ...
          <div className="bg-brand-surface/5 border border-white/10 p-8 backdrop-blur-md relative group">
            ...
            <div className="mb-8 text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-gold/5 border border-brand-gold/10 mb-4">
                ...
                <span className="text-[10px] font-mono text-brand-gold uppercase tracking-widest">Welcome Back</span>
              </div>
              <h1 className="text-2xl font-serif text-stone-100 mb-2">Sign In</h1>
              <p className="text-stone-500 text-sm">Enter your email and password to access your workspace.</p>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="flex justify-end">
                    <Link to="/forgot-password" className="text-xs text-stone-500 hover:text-brand-gold transition-colors">
                      Forgot password?
                    </Link>
                  </div>
                </div>
            ...
            <div className="mt-8 pt-6 border-t border-white/5 text-center">
              <p className="text-xs text-stone-500 font-mono">
                ...
                <a href="#" className="text-stone-400 hover:text-brand-gold underline decoration-stone-700 underline-offset-2">Terms of Service</a> and <a href="#" className="text-stone-400 hover:text-brand-gold underline decoration-stone-700 underline-offset-2">Privacy Policy</a>.
              </p>
            </div>
          </div>

          {/* System Status Footer */}
          <div className="mt-8 flex justify-center items-center text-[10px] font-mono text-stone-600 uppercase tracking-widest">
            <span>© 2025 LexiSearch Intelligence Systems</span>
          </div>
        </div>
      </main>
    </div>
